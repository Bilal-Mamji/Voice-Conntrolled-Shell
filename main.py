...
def execute(mytext):
    if(mytext.lower() == 'send email'):
        ...
        modules.delete_dir()
        return
    elif(mytext.lower() == 'open youtube'):
        modules.youtube()
        return
    elif(mytext.lower() == 'open google'):
        modules.google()
        return
    elif(mytext.lower() == 'open facebook'):
        modules.facebook()
        return
    elif(mytext.lower() == 'open firefox'):
        modules.open_firefox()
        return
    elif(mytext.lower() == 'close firefox'):
        modules.close_firefox()
        return
    elif(mytext.lower() == 'time'):
        modules.time()
        return
    elif(mytext.lower() == 'calender'):
        modules.calender()
        return
    elif(mytext.lower() == 'username'):
        modules.username()
        return
    elif(mytext.lower() == 'root user'):
        modules.root()
        return
    elif(mytext.lower() == 'who is your owner'):
        modules.owner()
        return
    elif(mytext.lower() == 'clear'):
        modules.clear()
        return
    elif(mytext.lower() == 'what is the day'):
        modules.day()
        return
    else:
